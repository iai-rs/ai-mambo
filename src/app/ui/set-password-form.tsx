...
export default function SetPasswordForm() {
  // const [errorMessage, formAction] = useFormState(setPassword, null);
  const [password, setFrontendPassword] = useState("");
  ...
  const setPasswordF = () => {
    ...
    setPassword(tempKey ? tempKey : "", email ? email : "", newPassword);
  }
